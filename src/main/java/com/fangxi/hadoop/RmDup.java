...
public class RmDup extends Configured implements Tool {
    ...
    /*输出：Text——每一个数据，NullWritable——对应的数量*/
    private static NullWritable nullval = NullWritable.get();
    ...
    public static void main(String[] args) {
        try {
            Date start = new Date();
            int result = ToolRunner.run(new RmDup(), args);
